      ...
      <div class="Rfq">
        ...
        <div class="rfqtableHeader">
          <div class="tableHeader">
            <p class="tableHeadertext">Department Short Code</p>
            <img src="../../assets/images/sorticon.svg" class="sorticon" v-on:click="ascending = !ascending" />
          </div>
          <div class="tableHeader">
            <p class="tableHeadertext">Department</p>
            <img src="../../assets/images/sorticon.svg" class="sorticon" v-on:click="ascending = !ascending" />
          </div>
        </div>

        <div v-for="department in filteredUsers" :key="department.id" class="rfqtableHeader" :style="{ cursor: 'pointer' }"
          @click="editDepartment(department.shortCode, user.departmentDescription)"
          :onClick="onEdit">
          <p class="tablerowtext">{{ department.shortCode }}</p>
          <p class="tablerowtext">{{ department.departmentDescription }}</p>
        </div>
