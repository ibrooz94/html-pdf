...
export default {
  ...
  data() {
    return {
      ...
      purchcontracts: [
        { "PONums": "PO2568", "description": "Building Maintenance", "contractdatetime": "2023-11-15 14:53 GTM+1" },
        { "PONums": "PO2569", "description": "Building Maintenance", "contractdatetime": "2022-03-31 14:53 GTM+1" },
        { "PONums": "PO2570", "description": "IT Infrastructure", "contractdatetime": "2022-08-12 14:53 GTM+1" },
        { "PONums": "PO2571", "description": "Building Maintenance", "contractdatetime": "2023-03-02 14:53 GTM+1" },
        { "PONums": "PO2572", "description": "Building Maintenance", "contractdatetime": "2010-02-30 14:53 GTM+1" },
        { "PONums": "PO2573", "description": "IT Infrastructure", "contractdatetime": "2022-04-18 14:53 GTM+1" },
      ]
    };
  },
  computed: {
    ...
    filteredContracts() {
      ...
      if (this.startDate && this.endDate) {
        contracts = this.purchcontracts.filter((item) => {
          return this.startDate <= item.contractdatetime.slice(0, -12) && item.contractdatetime.slice(0, -12) <= this.endDate;
        })
      }
      ...
      contracts = contracts.sort((a, b) => {
        if (this.sortBy == 'alphabetically') {
          let fa = a.contractdatetime.slice(0, -12).toLowerCase(), fb = b.contractdatetime.slice(0, -12).toLowerCase()
